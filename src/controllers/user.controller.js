...
const registerUser = asyncHandler(async (req,res)=> {
    ...
    //create user noject -create entry in db
   ...
   if([fullName,email,username,password].some((field)=>field.trim()=="")){
    throw new ApiError(400,"All fields are reqs")
   }
...
if(!avatar){
    throw new ApiError(409,"No avatar")
}
...
if(!createdUser){
 ...
 res.status(201).json(new ApiResponse(200,createdUser,"User Registered uccessfully"))
})
